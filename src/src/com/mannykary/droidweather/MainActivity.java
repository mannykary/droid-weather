...
public class MainActivity extends Activity {
	...
	public void displayForecast(){	
		...
		if ( units.equals("US") ){
			...
			day1Low.setText(data.get("day2_low_f"));
			day2Low.setText(data.get("day3_low_f"));
			...
			day1Low.setText(data.get("day2_low_c"));
			day2Low.setText(data.get("day3_low_c"));
	    ...
	    day1Cond.setImageResource(getResources().getIdentifier(data.get("day1_cond"), "drawable",  getPackageName()));
		
	    ImageView day2Cond = (ImageView) findViewById(R.id.forecastDay2Graphic);  
	    day2Cond.setImageResource(getResources().getIdentifier(data.get("day2_cond"), "drawable",  getPackageName()));
	    
	    ImageView day3Cond = (ImageView) findViewById(R.id.forecastDay3Graphic);  
	    day3Cond.setImageResource(getResources().getIdentifier(data.get("day3_cond"), "drawable",  getPackageName()));
	    
	    ImageView day4Cond = (ImageView) findViewById(R.id.forecastDay4Graphic);  
	    day4Cond.setImageResource(getResources().getIdentifier(data.get("day4_cond"), "drawable",  getPackageName()));
	    
	    ImageView day5Cond = (ImageView) findViewById(R.id.forecastDay5Graphic);  
	    day5Cond.setImageResource(getResources().getIdentifier(data.get("day5_cond"), "drawable",  getPackageName()));
